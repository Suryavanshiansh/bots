...
- **Run Locally**:
  ...
  python bot.py
  ```
- **Cloud Start Command**: `python word_guess/bot.py` or `python bot.py` (inside `word_guess` directory)
...
- **Run Locally**:
  ...
  npm start
  ```
- **Cloud Start Command**: `node word-solver-bot/index.js` or `node index.js`
